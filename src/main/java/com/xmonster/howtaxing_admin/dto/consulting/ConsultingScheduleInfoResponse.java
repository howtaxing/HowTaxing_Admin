...
public class ConsultingScheduleInfoResponse {
    ...
    private List<ConsultingDateInfo> consultingDateInfoResponseList;                        // 상담일정보목록
    ...
    private List<ConsultingAvailableTimeInfo> consultingAvailableTimeInfoResponseList;      // 상담가능시간정보목록
    ...
    @NoArgsConstructor
    @Builder
    public static class ConsultingDateInfo {
    ...
    @NoArgsConstructor
    @Builder
    public static class ConsultingAvailableTimeInfo {
